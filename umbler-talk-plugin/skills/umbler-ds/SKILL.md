...
name: umbler-ds
description: |
  Gera telas, fluxos e componentes HTML usando o Umbootstrap Design System — o DS proprietário da Umbler Talk baseado em Bootstrap 5.3. Use esta skill sempre que o usuário pedir para criar uma nova tela, protótipo, fluxo, componente, ou ajustar/recriar uma tela existente que deva seguir o padrão visual do Umbler Talk. Também acione quando o usuário mencionar "DS", "design system", "Umbootstrap", "Umbler DS", "crie uma tela", "protótipo", "gere o HTML", "ajuste esta tela", ou enviar uma URL/screenshot de uma tela para ser recriada com componentes do DS. Não use para tarefas genéricas de HTML/CSS que não sejam do ecossistema Umbler.
---
