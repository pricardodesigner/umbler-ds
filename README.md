...
- **`umbootstrap-design-system.html`** — HTML único com todos os tokens, componentes e templates do DS.

## Raw URL (consumida pela skill `umbler-ds`)

```
https://raw.githubusercontent.com/pricardodesigner/umbler-ds/main/umbootstrap-design-system.html
```
